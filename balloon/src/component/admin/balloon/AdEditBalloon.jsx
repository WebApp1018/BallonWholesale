...
const AdEditBalloon = ({
  ...
  useEffect(() => {
    if (productDetail) {
      ...
      setProduct(productDetail.name);
      setDetail(productDetail.detail);
  ...
  const onSubmit = (e) => {
    ...
    axios
      .post(
        process.env.REACT_APP_API_BASE_URL + "api/product/edit_product",
        formData,
        {
          headers: {
  ...
  return (
    <div
      ...
      style={{ display: show === "edit" ? "flex" : "none" }}
    >
